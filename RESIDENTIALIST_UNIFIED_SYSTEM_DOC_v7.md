...
### Appliances — Early Work, Large Scope (Dishwashers LOCKED above)
- Dishwashers: Now LOCKED (see above). Ranges/cooktops and refrigerators next.
- Each appliance subcategory is essentially its own category build
- Yale Appliance = primary independent source
- **Next:** Start ranges/cooktops or refrigerators. Follow Category Onboarding Ritual.
...
23. **Start next appliance subcategory** — ranges/cooktops or refrigerators. Follow Category Onboarding Ritual.

### LAUNCH ROADMAP (Defined March 30, 2026)

**MILESTONE: Four launch categories LOCKED** — Windows (32 products), Countertops (6), Cabinets (6), Faucets (6). Methodology proven. Pipeline works. But not enough category coverage to produce a report that justifies $500. A $3M home has windows, countertops, cabinets, faucets, appliances, HVAC, flooring, lighting, doors, and more. Four categories is half an answer. Need full-home coverage before first sale.
...
*Last updated: March 31, 2026 (v7)*
*This document replaces v6 (RESIDENTIALIST_UNIFIED_SYSTEM_DOC_v6.md)*
*Changes in v7: Dishwasher deep dives processed (6 major corrections), calibration v2 built (targets: 95/91/81/67/64/47), Whirlpool promoted Tier 4→Tier 3, 6 curation files built, investigator bot run (6 reports + summary), Bosch 800 rack glide verified, Mac Mini node.js path and API key loading documented.*
*Next session: Start next appliance subcategory (ranges/cooktops or refrigerators)*
